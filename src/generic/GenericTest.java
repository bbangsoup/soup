...
//        strStream.forEach(System.out::println);
        ...
        LinkedList<Integer> intArr = new LinkedList<>();    // 정수(Integer형)을 저장할 수 있는 링크드 리스트

        System.out.println("\n------------SET--------");


        // Set : 중복 데이터를 허용하지 않음. 순서가 없음(인덱싱을 지원하지 않음)
